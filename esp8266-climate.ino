...
const char* ssid     = "Climate"; // <-- enter wi-fi name from earlier (ex: Climate)
const char* password = "cl!mate123"; // <-- enter wi-fi password from earlier (ex: cl!mate123)
